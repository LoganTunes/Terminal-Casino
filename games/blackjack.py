...
async def run_blackjack(balance):
    ...
    # ============================================================
    #             5-SPOT BETTING CIRCLE COORDINATES
    # ============================================================

    betting_spots = [
        pygame.Rect(180, 440, 75, 75),
        pygame.Rect(310, 460, 75, 75),
        pygame.Rect(437, 465, 75, 75),  # Main active spot
        pygame.Rect(565, 460, 75, 75),
        pygame.Rect(695, 440, 75, 75),
    ]
    ...
    chip_selections = [
        ...
        (50, pygame.Rect(685, 560, 32, 32), (180, 30, 30), (240, 240, 240)),
        (100, pygame.Rect(725, 560, 32, 32), (30, 80, 180), (240, 240, 240)),
        (250, pygame.Rect(765, 560, 32, 32), (30, 130, 60), (212, 163, 89)),
        (1000, pygame.Rect(805, 560, 32, 32), (40, 40, 40), (230, 185, 105)),
    ]
    ...
    def draw_table_stencils(surface):
      ...
      # Arc positioned cleanly ABOVE the player's cards
      pygame.draw.arc(
          surface,
          GOLD_TEXT,
          (100, 140, 750, 160),
    ...
    def draw_dealer_chip_rack(surface):
      # Resized rack width for exactly 5 slots (278px centered at X=336)
      ...
      # 5 chip colors matching the game's 5 available wager tiers ($10, $50, $100, $250, $1000)
      rack_colors = [
          (240, 240, 240),  # White ($10)
          (180, 30, 30),    # Red ($50)
          (30, 80, 180),    # Blue ($100)
          (30, 130, 60),    # Green ($250)
          (40, 40, 40),     # Black ($1000)
    ...
    # ============================================================
    #             SEQUENTIAL REAL-TIME DEALER TURN
    # ============================================================


    def process_dealer_turn(current_time):
      nonlocal dealer_timer, game_stage, win_message, balance, current_bet
    ...
    while running:
          ...
          if game_stage == "BETTING":
            ...
            if deal_trigger_rect.collidepoint(mouse_pos):
              if current_bet > 0:
                ...
                # Player cards sit at Y = 320, Dealer cards at Y = 75
                player_hand = [
      ...
      # ============================================================
      #          VEGAS SEMI-CIRCULAR FELT & WOOD RENDERING
      # ============================================================

      screen.fill(MAHOGANY)

      # Leather Rail & Wood Trim
      pygame.draw.ellipse(
      ...
      banner_rect = pygame.Rect(45, 660, 805, 45)
