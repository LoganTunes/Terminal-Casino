...
# ----------------------------------------------------------------
# Prevent Windows High-DPI scaling from compressing/blurring Pygame
# ----------------------------------------------------------------
try:
...
screen = pygame.display.set_mode((LOBBY_WIDTH, LOBBY_HEIGHT), pygame.RESIZABLE)
            ...
            if event.type == pygame.QUIT:
                ...
                if reset_btn_rect.collidepoint(mouse_pos):
                    ...
                    if result is not None:
                        ...
                        print("Game returned None; preserving current balance.")
